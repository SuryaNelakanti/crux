...
export function DoodleSpiral({ style }: { style?: React.CSSProperties }) {
  return (
    ...
    >
      <path
        d="M50,50 m-2,0 a2,2 0 1,0 4,0 a4,4 0 1,0 -8,0 a8,8 0 1,0 16,0 a16,16 0 1,0 -32,0 a24,24 0 1,0 48,0"
        style={{
          strokeDasharray: 200,
...
export function DoodleStar({ style }: { style?: React.CSSProperties }) {
  return (
    <svg aria-hidden="true" viewBox="0 0 40 40" style={{ width: 30, height: 30, ...style }}>
      <path
...
export function DoodleArrow({ style }: { style?: React.CSSProperties }) {
  return (
    ...
    >
      <path
        d="M10,25 Q30,5 50,25 T90,25 M80,15 L90,25 L80,35"
...
export function DoodleScribble({ style }: { style?: React.CSSProperties }) {
  return (
    ...
    >
      <path
        d="M10,20 Q20,5 30,20 T50,20 T70,20 T90,20 T110,20"
...
export function DoodleCircle({ style }: { style?: React.CSSProperties }) {
  return (
    ...
    >
      <path
        d="M90,50 A40,40 0 1,1 10,50 A40,40 0 1,1 90,50 M85,50 A35,35 0 1,0 15,50"
        style={{
          strokeDasharray: 300,
...
export function DoodleAnchor({ style }: { style?: React.CSSProperties }) {
  return (
    ...
    >
      ...
      <path
        d="M50,20 A6,6 0 1,0 50,8 A6,6 0 1,0 50,20 M50,20 L50,80 M20,55 Q50,95 80,55 M30,35 L70,35"
        style={{ animation: 'drawStroke 2s ease-out forwards' }}
      />
    </svg>
  );
...
export function DoodleZigzag({ style }: { style?: React.CSSProperties }) {
  return (
    ...
    >
      <path
        d="M5,15 L15,5 L25,25 L35,5 L45,25 L55,5 L65,25 L75,5 L85,25 L95,15"
  ...
  return (
    ...
    >
      {doodles.map((d) => {
        ...
        let Component: React.ComponentType<{ style?: React.CSSProperties }>;
        switch (d.type) {
          case 'spiral':
            Component = DoodleSpiral;
            break;
          case 'star':
            Component = DoodleStar;
            break;
          case 'arrow':
            Component = DoodleArrow;
            break;
          case 'scribble':
            Component = DoodleScribble;
            break;
          case 'underline':
            Component = DoodleUnderline;
            break;
          case 'circle':
            Component = DoodleCircle;
            break;
          case 'anchor':
            Component = DoodleAnchor;
            break;
          case 'zigzag':
            Component = DoodleZigzag;
            break;
          default:
            Component = DoodleSpiral;
        }
