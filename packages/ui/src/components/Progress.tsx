 ...
 */
export function Progress({ value, label, showPercentage = false, height = 8 }: ProgressProps) {
  ...
  return (
    <Box gap="xs">
      ...
      <Box backgroundColor="bgMuted" borderRadius="full" overflow="hidden" height={height}>
        <AnimatedBox
          style={animatedStyle}
