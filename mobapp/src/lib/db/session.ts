...
export async function createSession(gymLabel: string | null = null): Promise<Session> {
...
export async function endSession(sessionId: string): Promise<void> {
  ...
  await db.runAsync('update sessions set end_ts = ? where id = ?', [now.toISOString(), sessionId]);
